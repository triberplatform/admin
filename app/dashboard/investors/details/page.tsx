...
const InvestorDetailsPage: React.FC = () => {
  ...
  const mapDocsToDocuments = (): Document[] => {
    ...
    if (investor.termsOfAgreementDocUrl) {
      const fileType: string = getFileTypeFromUrl(investor.termsOfAgreementDocUrl);
    ...
    if (investor.proofOfBusinessDocUrl) {
      const fileType: string = getFileTypeFromUrl(investor.proofOfBusinessDocUrl);
    ...
    <div className="px-6 ml-[20%]">
      ...
      <div className="py-6 flex justify-between items-start">
        <div className="flex items-start gap-4">
          ...
          <div>
            ...
            <p className="text-gray-600">{investor.companyType.replace(/_/g, " ")}</p>
            <div className="mt-4">
              <Link 
      ...
      <div className="mt-10 mb-10">
        ...
        <div className="border border-gray-200 rounded-lg p-6">
          <p className="text-gray-700">{investor.about || "No about information provided."}</p>
        </div>
      </div>
      ...
      <div className="mt-10 mb-10">
            ...
            <InfoGrid 
              items={[
                ...
                { 
                  ...
                  value: investor.numOfExpectedDeals ? investor.numOfExpectedDeals.replace(/_/g, " ").toLowerCase() : "Not provided" 
                },
              ]} 
            />
          </div>
        ...
        <div className="mt-6 border border-gray-200 rounded-lg p-4">
          <h3 className="text-green-600 font-medium mb-4">Interested Locations</h3>
          <div className="flex flex-wrap gap-2">
            {parseJsonString(investor.interestedLocations).map((location, index) => (
              <span 
                key={index}
        ...
        <div className="mt-6 border border-gray-200 rounded-lg p-4">
          ...
          <div className="flex flex-wrap gap-2">
            {parseJsonString(investor.interestedFactors).map((factor, index) => (
              <span 
                key={index}
