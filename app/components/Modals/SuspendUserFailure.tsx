...
interface SuspendUserFailureModalProps {
  /**
...
/**
 * Displays an error message when user suspension fails
 */
const SuspendUserFailureModal: React.FC<SuspendUserFailureModalProps> = ({ 
  isOpen, 
  onClose, 
  onRetry 
}) => {
...
export default SuspendUserFailureModal;