...
interface UnsuspendUserFailureModalProps {
  /**
...
/**
 * Failure modal shown if unsuspending a user fails
 */
const UnsuspendUserFailureModal: React.FC<UnsuspendUserFailureModalProps> = ({
  isOpen,
  onClose,
  onRetry
}) => {
    ...
    <Modal isOpen={isOpen} onClose={onClose} title="Error">
      <div className="flex flex-col items-center py-8">
        ...
        <p className="text-center text-gray-500 mb-6">
          There was an error while trying to unsuspend this user. Please try again.
        </p>
...
export default UnsuspendUserFailureModal;