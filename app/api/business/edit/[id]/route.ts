// /app/api/business/edit/[id]/route.ts
...
export async function PUT(
  ...
  try {
    ...
    let businessData: EditBusinessPayload;
    try {
    ...
    const response = await serverFetch<ApiResponse>(`/admin/business/edit/${businessId}`, {
      method: 'PUT',
      headers: {
        'Authorization': authHeader,
        'Content-Type': 'application/json'
      },
      data: businessData // Use data property for Axios
    });
